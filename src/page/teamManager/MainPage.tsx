...
const ManagerMainPage = ({navigation}: IManagerMainPageProps) => {
  ...
  const responsiveStyles = useMemo(() => {
    ...
    return {
      ...
      headerTopPadding: Platform.OS === 'ios' ? Math.round(60 * scale) : Math.round(40 * scale),
  ...
  return (
    <ManagerLayout headerShown={false} color="#3287F8" top={false}>
      <View style={[styles.headerContainer, {
        ...
        <Typo style={[styles.appName, { fontSize: responsiveStyles.appNameSize }]}>하늘애</Typo>
        <View style={[styles.leftHeaderContainer, { gap: responsiveStyles.buttonSpacing }]}>
          <CustomButton onPress={logout} style={[styles.loginButton, {
            ...
            <Typo color="white" style={[styles.buttonText, { fontSize: responsiveStyles.buttonTextSize }]}>
              로그아웃
            </Typo>
            <LoginIcon />
          </CustomButton>
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={{flex: 1, justifyContent: 'flex-end'}}>
          <ImageBackground
            ...
            <CustomButton onPress={goToSearchPage} style={[styles.SearchButton, {
              ...
              <View style={[styles.buttonTextContainer, {
                ...
                <Typo style={[styles.buttonTitle, { fontSize: responsiveStyles.buttonTitleSize }]}>장례식장</Typo>
                <View style={[styles.buttonTextSubContainer, {
                  gap: responsiveStyles.iconGap,
                  marginTop: responsiveStyles.iconGap,
                }]}>
                  <Typo style={[styles.buttonSub, { fontSize: responsiveStyles.buttonSubSize }]}>찾아보기</Typo>
            ...
            <CustomButton onPress={goToNoticePage} style={[styles.NoticeButton, {
              ...
              <View style={[styles.buttonTextContainer, {
                ...
                <Typo style={[styles.buttonTitle2, { fontSize: responsiveStyles.buttonTitleSize }]}>견적내역</Typo>
                <View style={[styles.buttonTextSubContainer, {
                  gap: responsiveStyles.iconGap,
                  marginTop: responsiveStyles.iconGap,
                }]}>
                  <Typo style={[styles.buttonSub2, { fontSize: responsiveStyles.buttonSubSize }]}>확인하기</Typo>
          ...
          <View style={[styles.footerContainer, {
            ...
            <Typo style={[styles.footerText, { fontSize: responsiveStyles.footerTextSize }]}>고객센터</Typo>
            <Typo style={[styles.footerNumber, { fontSize: responsiveStyles.footerTextSize }]}>02-123-4567</Typo>
          </View>
        </View>
      </View>
    </ManagerLayout>
