    ...
    return (
      <ManagerLayout
        ...
        <View
          ...
          <Typo
            style={[styles.errorText, {fontSize: responsiveStyles.labelSize}]}>
            ❌ {error}
          </Typo>
        </View>
      </ManagerLayout>
        ...
        <View
          ...
          <View
            ...
            <View style={[styles.labelContainer, {gap: responsiveStyles.gap}]}>
              <CommaIcon
                width={responsiveStyles.commaIconSize}
                height={responsiveStyles.commaIconSize}
              />
              <Typo
                style={[styles.label, {fontSize: responsiveStyles.labelSize}]}>
                장례식장
              </Typo>
            </View>
            <Typo
              style={[styles.value, {fontSize: responsiveStyles.valueSize}]}>
              {managerFormBidDetail?.funeralHallName}
            </Typo>
          </View>
          <View
            style={[
            ...
            <Typo
              style={[styles.value, {fontSize: responsiveStyles.valueSize}]}>
              {managerFormBidDetail?.funeralHallSize}평
            </Typo>
          </View>
          <View
            style={[
            ...
            <Typo
              style={[styles.value, {fontSize: responsiveStyles.valueSize}]}>
              {managerFormBidDetail?.funeralHallNumberOfMourners}명
            </Typo>
          </View>
          <View
            style={[
            ...
            <Typo
              style={[styles.value, {fontSize: responsiveStyles.valueSize}]}>
              {managerFormBidDetail?.funeralHallDetailPrice}만원
            </Typo>
          </View>
          <View
            style={[
            ...
            <Typo
              style={[styles.value, {fontSize: responsiveStyles.valueSize}]}>
              {managerFormBidDetail?.funeralHallPrice}만원
            </Typo>
          </View>
          <View
            style={[
            ...
            <Typo
              style={[
                ...
                (managerFormBidDetail?.funeralHallPrice || 0) +
                  (managerFormBidDetail?.funeralHallDetailPrice || 0) >
                  (managerFormBidDetail?.funeralProponentMoney
                    ? managerFormBidDetail.funeralProponentMoney / 10000
                    : 0) && {textDecorationLine: 'line-through', color: '#999'},
              ]}>
              {(managerFormBidDetail?.funeralHallPrice || 0) +
                (managerFormBidDetail?.funeralHallDetailPrice || 0)}
              만원
          ...
          <View
            ...
            <Typo
              style={[styles.value, {fontSize: responsiveStyles.valueSize}]}>
              {managerFormBidDetail?.funeralProponentMoney}만원
            </Typo>
          </View>
          <View
            style={[
            ...
            <Typo
              ...
              {managerFormBidDetail?.funeralDiscount}%
            </Typo>
          </View>
        </View>
      </View>
        ...
        <CustomButton
          ...
          <View style={[styles.buttonIcon, {gap: responsiveStyles.buttonGap}]}>
            ...
            <Typo
              ...
              color={hasBidSelected ? '#999' : 'white'}>
              {hasBidSelected
                ? '이미 다른 장례식장에 출동 신청을 했습니다'
                : '출동신청서 작성'}
            </Typo>
          </View>
          {!hasBidSelected && (
